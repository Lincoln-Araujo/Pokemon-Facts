...
export const pokemons = {
    bulbasaur: {
        image: require('../src/images/bulbasaur.png'),
        title: 'Seed Pokemon',
        type:  'grass/poison',
        height:'0.7 m',
        weight:'6.9 kg',
    ...
    charmander: {
        image: require('../src/images/charmander.png'),
    ...
    squirtle: {
        image: require('../src/images/squirtle.png'),
    ...
    pikachu: {
        image: require('../src/images/pikachu.png'),
        title: 'Mouse Pokemon',
        type:  'electric',
        height:'0.4 m',
        weight:'6.0 kg',
